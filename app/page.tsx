...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-[#0a1810]">
      ...
      {/* Secciones accesibles desde los botones del héroe */}

      {/* El simulador y la guía se movieron a páginas dedicadas */}
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href="/configuracion" className="text-muted-foreground hover:text-primary transition-colors">
                    Configuración
                  </Link>
                </li>
                <li>
